...
const SearchBar = forwardRef<HTMLInputElement, SearchBarProps>(
  function SearchBar({ value, onChange, onSearch }, ref) {
    ...
    return (
      <form onSubmit={handleSubmit} className="relative">
        <motion.div
          ...
          className="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 transition-colors focus-within:border-sky-300 dark:border-slate-700 dark:bg-slate-800"
        >
